...
+ Lớp ứng dụng: trên EKS (Phase 1) gồm <code>frontend</code>, <code>productcatalogservice</code>, <code>cartservice</code>, <code>checkoutservice</code> và Redis trong cluster; môi trường local chạy thêm các service phụ trợ (currency, payment, shipping, email) để kiểm thử checkout đầy đủ.
