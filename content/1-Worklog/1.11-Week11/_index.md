...
| 4–5 | **Monolith to Microservices:** <br>&emsp; + Analyze how to split a monolith into microservices by bounded context. <br>&emsp; + Package each service as its own image and prepare registry and independent deploy configuration. | July 1, 2026 | July 2, 2026 | <https://cloudjourney.awsstudygroup.com/4-modernize/> |
| 6 | **CI/CD for containers:** <br>&emsp; + Learn pipelines to build images, push to ECR, and update deployment manifests. <br>&emsp; + Get familiar with GitHub Actions (or CodePipeline) for a basic build — scan — deploy flow. | July 3, 2026 | July 3, 2026 | <https://000126.awsstudygroup.com/> |
