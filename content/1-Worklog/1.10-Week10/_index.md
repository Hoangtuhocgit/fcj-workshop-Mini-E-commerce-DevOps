...
| 3–4 | **Basic Docker practice:** <br>&emsp; + Write a Dockerfile for a sample application, build a Docker image, and run containers locally. <br>&emsp; + Use basic Docker commands to inspect containers, images, logs, port mappings, and clean up resources. | June 23, 2026 | June 24, 2026 | <https://000015.awsstudygroup.com/> |
| 5 | **Amazon Elastic Container Registry (Amazon ECR):** <br>&emsp; + Create a private repository, authenticate to ECR with the AWS CLI, and push a Docker image. <br>&emsp; + Verify image tags, versions, and repository access permissions before deployment. | June 25, 2026 | June 25, 2026 | <https://000067.awsstudygroup.com/> |
| 6 | **Amazon ECS and AWS Fargate:** <br>&emsp; + Understand ECS clusters, task definitions, services, Fargate, and running containers without managing servers. | June 26, 2026 | June 26, 2026 | <https://000067.awsstudygroup.com/> |
| 7–Sun | **Amazon EKS and container deployment practice:** <br>&emsp; + Learn Kubernetes/EKS architecture: cluster, node, pod, deployment, service, namespace, and kubectl. <br>&emsp; + Deploy a sample application with Deployment and Service, verify pods, replicas, and self-healing behavior. <br>&emsp; + Monitor resource status with kubectl and CloudWatch at a basic level. <br> **Post-lab cleanup:** <br>&emsp; + Delete deployments, services, pods, unused Docker images, and review the Amazon ECR repository. <br>&emsp; + Review ECS/EKS/Fargate-related resources to limit unexpected charges. | June 27, 2026 | June 28, 2026 | <https://000126.awsstudygroup.com/><br><https://000067.awsstudygroup.com/> |
